---
title: Installation
description: Install the complete Rottweiler bundle on Apple silicon macOS or x86-64 Linux and verify it.
sidebar:
  order: 1
---
...
curl --fail --location --proto '=https' --tlsv1.2 \
  ...
  https://github.com/Boredphilosopher96/Rottweiler/releases/download/{{stable_tag}}/rottweiler-install.sh
