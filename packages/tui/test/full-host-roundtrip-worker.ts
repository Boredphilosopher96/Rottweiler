...
const app = createRottweilerApp(setup.renderer, { sessionReader: runtime.sessionReader, familyControls: runtime.familyControls, allocations: runtime.allocations,
