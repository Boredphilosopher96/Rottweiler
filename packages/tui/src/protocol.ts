...
export type { SessionSearchMatch, SessionSearchHit, SessionDescriptor, SessionActivity } from "../../../protocol/types"
export type { WorkspaceChange, WorkspaceChangeKind } from "../../../protocol/types"
