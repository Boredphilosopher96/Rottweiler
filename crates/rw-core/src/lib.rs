...
pub use engine::{
    ...
    SessionCommandAction, SessionCommandCatalog, SessionCommandContext, SessionCommandOutput,
    SessionEventDelivery, SessionEventReadView, SessionEventSink, SessionExtensionController,
    SessionExtensionSnapshot, SessionHandle, SessionProjectionError, SessionRecoveredState,
