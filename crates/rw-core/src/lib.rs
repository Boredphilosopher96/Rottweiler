...
pub use engine::{
    ...
    PluginSessionBinding, PluginSessionCapability, PreparedRuntimePublication, RecoveredQuestion,
    RewindCheckpoint, RuntimePublication, SESSION_EVENT_VERSION, SecretRedactor,
    SessionAccountingState, SessionActor, SessionActorConfig, SessionActorRecovery,
    SessionCommandAction, SessionCommandContext, SessionCommandOutput, SessionEventDelivery,
    SessionEventReadView, SessionEventSink, SessionExtensionController, SessionExtensionSnapshot,
    SessionHandle, SessionProjectionError, SessionRecoveredState, SessionReplayLimits,
    SessionResources, SessionSnapshot, SessionSubscription, SessionUsage, StartupNotification,
    SystemEventClock, TOOL_CANCELLATION_GRACE, WorkspaceRootController, WorkspaceRootRequest,
