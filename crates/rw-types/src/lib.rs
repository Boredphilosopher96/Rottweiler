...
pub use protocol::{
    ...
    MAX_COMMAND_REPLY_BYTES, MAX_SESSION_ID_BYTES, McpApprovalReview, McpEnvironmentEntry,
    ...
    ModelDescriptor, ModelSwitchQuestion, PermissionApprovalDescriptor, PermissionApprovalScope,
    ...
    SubagentActivity, SubagentDescriptor, SubagentId, SubagentIsolation, SubagentReplayItem,
