...
pub use client::{
    ...
    UiPanelSnapshot, UiPanelUpdate, UiPanelUpdated, UiPanels, UiPresentation,
};
mod wire_bounds;
use wire_bounds::{
...
pub const MAX_UI_PANEL_SLOTS: usize = 8;
pub const MAX_UI_PANELS_BYTES: usize = MAX_UI_PANEL_SLOTS * MAX_UI_SURFACE_BYTES;
