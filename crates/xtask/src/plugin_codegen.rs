...
use rw_plugin_protocol::{
    ...
    MAX_VERSION_BYTES, METHOD_COMMAND_EXECUTE, METHOD_EFFECT_TOOL_CALL, METHOD_EVENT_PUBLISH,
    METHOD_EVENT_READ, METHOD_EXIT, METHOD_EXTENSION_STATE_COMMIT, METHOD_EXTENSION_STATE_READ,
    METHOD_HOOK_INVOKE, METHOD_INITIALIZE, METHOD_PROVIDER_COMPLETE, METHOD_PROVIDER_CREDIT,
    METHOD_PROVIDER_EVENT, METHOD_PROVIDER_HTTP, METHOD_PROVIDER_HTTP_CANCEL,
    METHOD_PROVIDER_HTTP_EVENT, METHOD_PROVIDER_MODELS, METHOD_SESSION_CONTEXT_READ,
    METHOD_SESSION_CONTROL, METHOD_SESSION_INJECT_MESSAGE, METHOD_SESSION_QUERY,
    METHOD_SESSION_SET_STATUS, METHOD_SESSION_TOOL_CALL, METHOD_SHUTDOWN, METHOD_TOOL_CALL,
    METHOD_TOOL_PROGRESS, METHOD_UI_NOTIFY, METHOD_UI_PUBLISH_PANEL, PLUGIN_HOST_ID,
...
export type PluginPushMethod =
  ...
  | "session/control"
  | "session/tool_call" | "effect/tool_call"
...
fn methods() -> Value {
    json!({
        ...
        "effectToolCall": METHOD_EFFECT_TOOL_CALL,
