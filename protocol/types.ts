...
export const MAX_QUESTION_SET_BYTES = 65536 as const;
export const MAX_QUESTION_SET_PREPARED_BYTES = 262144 as const;
...
export type ChildControlResponse = { "type": "question", question_id: QuestionId, answers: Array<Answer>, } | { "type": "approval", tool_call_id: ToolCallId, invocation_id: ToolInvocationId, decision: ApprovalDecision, binding: ApprovalBinding | null, } | { "type": "plan", decision: PlanDecision, revisions: string | null, };
...
export type SessionQuestion = { question_id: QuestionId, turn_id: TurnId, questions: Array<Question>, };
