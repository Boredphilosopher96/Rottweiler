...
export const TRANSCRIPT_PROJECTION_VERSION = 3 as const;
...
export type TranscriptContentSelector = { "type": "conversation" } | { "type": "conversation_block", index: number, } | { "type": "tool_arguments" } | { "type": "tool_output" } | { "type": "tool_diff" } | { "type": "command_message" } | { "type": "shell_command" } | { "type": "shell_output" } | { "type": "subagent_task" } | { "type": "subagent_result" } | { "type": "subagent_diff" };
