...
export const TRANSCRIPT_PROJECTION_VERSION = 5 as const;
...
export type TranscriptTailTool = { source: SequenceId, turn_id: TurnId, tool_call_id: ToolCallId, invocation_id: ToolInvocationId, name: string, call_index: number, arguments: TranscriptBodyPreview, diff: TranscriptBodyPreview | null, output: TranscriptTailText, };
